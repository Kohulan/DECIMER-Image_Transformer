...
# Define encoder
def get_efficientnetv2_backbone(model_name, include_top=False, input_shape=(299,299,3), pooling=None, weights=None):
...
class Encoder(tf.keras.Model):
    def __init__(self, image_embedding_dim, preprocessing_fn, backbone_fn, image_shape, do_permute=False, include_top=False, pretrained_weights=None, scale_factor=0):
        ...
        self.encoder_backbone = backbone_fn(model_name=MODEL, include_top=include_top, weights=pretrained_weights, input_shape=image_shape)        
