...
class EfficientDetArchTest(tf.test.TestCase):
    ...
    def test_efficientdet_d0(self):
        self.assertSequenceEqual(
            (3880067, 2532997127), self.build_model("efficientdet-d0", 512)
        )
    ...
    def test_efficientdet_d0_511_513(self):
        self.assertSequenceEqual(
            (3880067, 2610687851), self.build_model("efficientdet-d0", (511, 513))
        )

    def test_efficientdet_d1(self):
        self.assertSequenceEqual(
            (6625898, 6095640824), self.build_model("efficientdet-d1", 640)
        )

    def test_efficientdet_d1_640_1280(self):
        self.assertSequenceEqual(
            (6625898, 12186897999), self.build_model("efficientdet-d1", (640, 1280))
        )

    def test_efficientdet_d2(self):
        self.assertSequenceEqual(
            (8097039, 10986053156), self.build_model("efficientdet-d2", 768)
        )

    def test_efficientdet_d3(self):
        self.assertSequenceEqual(
            (12032296, 24869554579), self.build_model("efficientdet-d3", 896)
        )

    def test_efficientdet_d4(self):
        self.assertSequenceEqual(
            (20723675, 55146068329), self.build_model("efficientdet-d4", 1024)
        )

    def test_efficientdet_d5(self):
        self.assertSequenceEqual(
            (33653315, 135306619957), self.build_model("efficientdet-d5", 1280)
        )

    def test_efficientdet_d6(self):
        self.assertSequenceEqual(
            (51871782, 225467043531), self.build_model("efficientdet-d6", 1280)
        )

    def test_efficientdet_d7(self):
        self.assertSequenceEqual(
            (51871782, 324657914255), self.build_model("efficientdet-d7", 1536)
        )

    def test_efficientdet_lite0(self):
        self.assertSequenceEqual(
            (3243470, 977617221), self.build_model("efficientdet-lite0")
        )

    def test_efficientdet_lite1(self):
        self.assertSequenceEqual(
            (4248318, 1973728714), self.build_model("efficientdet-lite1")
        )

    def test_efficientdet_lite2(self):
        self.assertSequenceEqual(
            (5252334, 3383232590), self.build_model("efficientdet-lite2")
        )

    def test_efficientdet_lite3(self):
        self.assertSequenceEqual(
            (8350862, 7503764515), self.build_model("efficientdet-lite3")
        )

    def test_efficientdet_lite3x(self):
        self.assertSequenceEqual(
            (9280862, 14019809178), self.build_model("efficientdet-lite3x")
        )

    def test_efficientdet_lite4(self):
        self.assertSequenceEqual(
            (15130894, 20221443966), self.build_model("efficientdet-lite4")
        )
