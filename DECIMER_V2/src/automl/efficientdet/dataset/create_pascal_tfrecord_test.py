...
class CreatePascalTFRecordTest(tf.test.TestCase):
    ...
    def test_dict_to_tf_example(self):
        ...
        self._assertProtoEqual(
            example.features.feature["image/object/difficult"].int64_list.value, [1, 0]
        )
        self._assertProtoEqual(
            example.features.feature["image/object/truncated"].int64_list.value, [0, 0]
        )
        self._assertProtoEqual(
        ...
        expected_ann_json_dict = {
            ...
            "categories": [],
            "images": [
                {"file_name": "2012_12.jpg", "height": 256, "width": 256, "id": 1}
            ],
        }
