...
def data_loader(Smiles_Path):
	...
	for line in smiles.split('\n'):
		...
		try:
			SMILES_ = '<start> ' + str(tokens[1].replace("][","] [").rstrip()) + ' <end>'
	...
	top_k = 500
	tokenizer = tf.keras.preprocessing.text.Tokenizer(num_words=top_k,oov_token="<unk>",lower=False)
	...
	img_name_train, img_name_val, cap_train, cap_val = img_name_vector[0:1340000],img_name_vector[1340000:1440000],cap_vector[0:1340000],cap_vector[1340000:1440000]
