...
with open(Infile,"r") as fp:
	for i,line in enumerate(fp):
		...
		mols.append(rdMolDescriptors.GetMorganFingerprintAsBitVect(molecule,2,nBits=1024))
...
picks = mmp.LazyBitVectorPick(mols, len(mols),(how_many_to_pick+1)) #The time consuming process
